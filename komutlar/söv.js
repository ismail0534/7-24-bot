exports.run = async (client, msg, args) => {
 ...
 color: Math.floor(Math.random() * (0xFFFFFF + 1)),
 description: (`:no_entry_sign: Hoop! Birşeyler ters gitti ! Kayn#0001 etiketlemişsin yarram!`)
}})
  if(member.id === "324641670132137985")return msg.channel.send({embed: {
 color: Math.floor(Math.random() * (0xFFFFFF + 1)),
 description: (`:no_entry_sign: Hoop! Orda durucan Yapımcım ! Kayn#0001'na sövemezsin.`)
}})
